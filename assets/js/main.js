...
educationheader.addEventListener("click", () => {
  console.log("education before change:", education.classList);
  let condition1 = work.classList.contains("qualification_inactive");
  if (!condition1) {
    education.classList.remove("qualification_inactive");
    work.classList.add("qualification_inactive");
    workheader.style.color = "var(--text-color)";
    educationheader.style.color = "var(--first-color)";
    console.log("education after change:", education.classList);
    console.log("work after change:", work.classList);

  }
});
workheader.addEventListener("click", () => {
  let condition2 = education.classList.contains("qualification_inactive");
  console.log("work before change:", work.classList);
...
var typed = new Typed(".type", {
  strings: ["web developer", "machine learning researcher", "bubble tea enthusiast"],
  smartBackspace: true,
  startDelay: 1000,
  typeSpeed: 130,
  backDelay: 1000,
